    ...
    public partial class DatabaseCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_EventReviews_Events_TargetId",
                        column: x => x.TargetId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventReviews_Reviews_ReviewId",
                        column: x => x.ReviewId,
                        principalTable: "Reviews",
                        principalColumn: "ReviewId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_PlayerInterests_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerInterests_Sports_SportId",
                        column: x => x.SportId,
                        principalTable: "Sports",
                        principalColumn: "SportId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_PlayersOnEvents_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "EventId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayersOnEvents_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "PlayerId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerInterests_PlayerId",
                table: "PlayerInterests",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerInterests_SportId",
                table: "PlayerInterests",
                column: "SportId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayersOnEvents_EventId",
                table: "PlayersOnEvents",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayersOnEvents_PlayerId",
                table: "PlayersOnEvents",
                column: "PlayerId");
